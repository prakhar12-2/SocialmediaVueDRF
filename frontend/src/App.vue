  ...
  <nav class="py-10 px-8 border-b border-gray-200">
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between">
                    ...
                    <template v-else>
                        <div>
                        <RouterLink to="/signup" class="mr-4 py-4 px-6 bg-gray-600 text-white rounded-lg">Signup</RouterLink>
                        <RouterLink to="/login" class="py-4 px-6 bg-purple-600 text-white rounded-lg">Login</RouterLink>
                        </div>
                    </template>
                </div>
            </div>
